...
local function createImprovedDrill()
  ...
  local improvedDrill = clone(findEntry(data, "mining-drill", "electric-mining-drill"))
  ...
  gsubFilter(improvedDrill, ".png", "electric%-mining%-drill", "fusion-minidrill", ignoreKeys)
...
local function createAlienDrill()
  ...
  local alienDrill = clone(findEntry(data, "mining-drill", "electric-mining-drill"))
  ...
  gsubFilter(alienDrill, ".png", "electric%-mining%-drill", "fusion-drill", ignoreKeys)
